...
namespace AiCompetency.Api.Migrations
{
    ...
    [Migration("20260307050228_AddAdaptiveTestingEntities")]
    partial class AddAdaptiveTestingEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AiCompetency.Api.Models.AdaptiveResponse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal>("AbilityAfterResponse")
                        .HasColumnType("numeric")
                        .HasColumnName("ability_after_response");
                    ...
                    b.Property<decimal>("QuestionDifficultyLevel")
                        .HasColumnType("numeric")
                        .HasColumnName("question_difficulty_level");
                    ...
                    b.ToTable("adaptive_responses");
                });

            modelBuilder.Entity("AiCompetency.Api.Models.AdaptiveTestSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal>("CurrentAbilityEstimate")
                        .HasColumnType("numeric")
                        .HasColumnName("current_ability_estimate");

                    b.Property<DateTime?>("EndTime")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("end_time");

                    b.Property<int>("QuestionsAskedCount")
                        .HasColumnType("integer")
                        .HasColumnName("questions_asked_count");
            ...
            modelBuilder.Entity("AiCompetency.Api.Models.AdaptiveResponse", b =>
                {
                    ...
                    b.HasOne("AiCompetency.Api.Models.AdaptiveTestSession", "Session")
                        .WithMany("Responses")
